...
//       System.out.println("File.separator is '" + File.separator + "'.");
		...
		final String[] defs = FileHandling.getResourceListing(KnownDefines.class, "main/resources/def/", ".def");
        ...
        if (defs == null)
        {
        	...
        	{ 		
				...
				final URL url = KnownDefines.class.getResource("main/resources/def/rules/play/moves/StepToEmpty.def");

...
public class DesignPalette
{
    ...
    // FRAME //
    public static final ImageIcon LUDII_ICON = new ImageIcon(Objects.requireNonNull(DesignPalette.class.getResource("/img/ludii-logo-64x64.png")));
    // HEADER EDITORS //
    ...
    {
        return DesignPalette.class.getResource("/img/visual_editor/" +path);
    }

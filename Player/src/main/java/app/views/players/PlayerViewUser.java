...
public class PlayerViewUser extends View
{
	...
	private void drawPlayerName(final Graphics2D g2d, final int mover, final ArrayList<Integer> winnerNumbers, final Context context)
	{
		...
		if (SettingsExhibition.exhibitionVersion)
		{
			try(InputStream in = getClass().getResourceAsStream("/img/National-Regular.ttf"))
			{
	...
	void drawAIFace(final Graphics2D g2d)
	{
		...
		if (ai != null)
		{
			...
			String imagePath = "/img/svg/faces/symbola_cool.svg";
			if (happinessValue < -0.8)
				imagePath = "/img/svg/faces/symbola_sad.svg";
			else if (happinessValue < -0.5)
				imagePath = "/img/svg/faces/symbola_scared.svg";
			else if (happinessValue < -0.2)
				imagePath = "/img/svg/faces/symbola_worried.svg";
			else if (happinessValue < 0.2)
				imagePath = "/img/svg/faces/symbola_neutral.svg";
			else if (happinessValue < 0.5)
				imagePath = "/img/svg/faces/symbola_pleased.svg";
			else if (happinessValue < 0.8)
				imagePath = "/img/svg/faces/symbola_happy.svg";

...
public class BaseCardImages
{
	...
	public void loadImages(final int cardSizeInput)
	{
		...
		baseCardImagePaths[SUIT_LARGE][CLUBS]    = "/img/svg/cards/card-suit-club.svg";
		baseCardImagePaths[SUIT_LARGE][SPADES]   = "/img/svg/cards/card-suit-spade.svg";
		baseCardImagePaths[SUIT_LARGE][DIAMONDS] = "/img/svg/cards/card-suit-diamond.svg";
		baseCardImagePaths[SUIT_LARGE][HEARTS]   = "/img/svg/cards/card-suit-heart.svg";

		baseCardImagePaths[SUIT_SMALL][CLUBS]    = "/img/svg/cards/card-suit-club.svg";
		baseCardImagePaths[SUIT_SMALL][SPADES]   = "/img/svg/cards/card-suit-spade.svg";
		baseCardImagePaths[SUIT_SMALL][DIAMONDS] = "/img/svg/cards/card-suit-diamond.svg";
		baseCardImagePaths[SUIT_SMALL][HEARTS]   = "/img/svg/cards/card-suit-heart.svg";

		// Load the royal card figures
		baseCardImagePaths[BLACK_ROYAL][JACK]  = "/img/svg/cards/card-jack.svg";
		baseCardImagePaths[BLACK_ROYAL][QUEEN] = "/img/svg/cards/card-queen.svg";
		baseCardImagePaths[BLACK_ROYAL][KING]  = "/img/svg/cards/card-king.svg";

		baseCardImagePaths[RED_ROYAL][JACK]  = "/img/svg/cards/card-jack.svg";
		baseCardImagePaths[RED_ROYAL][QUEEN] = "/img/svg/cards/card-queen.svg";
		baseCardImagePaths[RED_ROYAL][KING]  = "/img/svg/cards/card-king.svg";
	}
